...
public class Handcuffs extends android.support.v4.app.Fragment {

    @Override
    public void onAttach(Context context) {
        MainActivity.myToolbar.setTitle("#Medida 2");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_handcuffs,container,false);
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.menu_handcuffs,menu);
    }
