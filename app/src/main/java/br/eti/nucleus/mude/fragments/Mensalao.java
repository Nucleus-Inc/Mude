...
public class Mensalao extends android.support.v4.app.Fragment {

    private static final String API_KEY = "AIzaSyCz2MkNyp2qYaGEsgcGTd2B2R0sjqbu8EI";
    private YouTubePlayerSupportFragment youTubePlayerSupportFragment;
    private static String VIDEO_ID = "rmcoWaYTWgA";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, final Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_mensalao,container,false);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.menu_mensalao,menu);
    }
